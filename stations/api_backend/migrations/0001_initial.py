    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info_block', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='info_button_reverse', to='api_backend.infoblock', verbose_name='При нажатии переход в этот инфоблок')),
